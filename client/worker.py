...
# `dossier` is the folder next to this file. Inserted so the client runs from
# a plain checkout with nothing installed — `python client/worker.py` and no
# more. A `pip install ./client` works too and does not need this.
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))

import aiohttp  # noqa: E402

from dossier import build as engine_build  # noqa: E402
from dossier import machine  # noqa: E402
from dossier import maps, runner, skins  # noqa: E402
from dossier.log import get_logger  # noqa: E402
