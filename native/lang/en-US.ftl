...
language-why = Every word after this will be in it.
continue = Continue
back = Back

folder-found = Found on this device.
folder-found-two = Found two on this device. Both are read; a switch leaves one out.
folder-missing = Couldn't find osu! on this device.
...
render-one = Render a replay — it will appear here.
when = when
who-and-map = who · map
mods = mods
length = length
...
why-sign-in = Link this device to Telegram — finished videos will go to your chat, and the worker can take jobs in your name.
sign-in = Sign in with Telegram
sign-in-how = Open the bot and press Start — it will get this code and link the device.
