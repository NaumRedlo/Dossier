...
step-folder = osu! folder
step-device = This device
step-bot = The bot

language-why = The language you pick changes every word in the application.
continue = Continue
back = Back
...
browse = Browse…
own-folder = Keep everything in its own folder
maps-from-mirrors = Maps come from the mirrors
skins-exported = skins, exported
maps-label = { $n ->
    [one] map
   *[other] maps
}
...
device-why = The worker's name — the bot will show it.
device-name = Name

bot-why = Scan it, or open Telegram here and confirm.
code-cap = Code · 10 minutes
open-telegram = Open Telegram
waiting-telegram = Waiting for Telegram…
linked = Linked
linked-to = Linked to @{ $who }
later = I would rather not link…
no-pairing-yet = The bot cannot link by code yet. Ask it for one.

check-folder = osu! folder
check-ffmpeg = ffmpeg
check-engine = Engine
check-bot = Bot
not-installed = Not installed
ffmpeg-why = Needed to render replays.
where-to-get = Where to get it
check-again = Check again
continue-anyway = Continue anyway
open-dossier = Open Dossier
asking-bot = Asking the bot…
same-build = Latest build
not-linked = Not linked
no-answer = No answer
download = Download
downloading = Downloading…
unpacking = Unpacking…
could-not-download = Did not download
mb = MB

replays = Replays
worker = Worker
settings = Settings
search-hint = Player, map, day
render = Render
get-the-map = Get the map
today = today
coming-later = Coming later!
back-to-replays = Back to replays
no-replays = No replays yet…
drop-here = Drop .osr files anywhere on this window.
...
month-11 = November
month-12 = December
replay-read = Replay read
map-on-disk = Map on disk
judged = Judged
drawing = Drawing…
saving = Saving…
stop = Stop
...
stopped = Stopped
seconds-left = { $n } s
looking-up = Looking for the map…
found-on = Found on { $who }
fetch-downloading = Downloading…
unpacking-into = Unpacking into Dossier/Songs…
...
judging = Judging…
in-folder = Show in folder
did-not-work = Did not work · once more
not-on-mirrors = Not on the mirrors · once more
reading = Reading…
looking = Looking…
found = Found!
unpacking-map = Unpacking…
checking-map = Checking
once-more = Once more
not-found = Not found
of-max = of { $max }
videos = Videos
no-videos = No videos yet
render-one = Render a replay and it will appear here.
when = when
who-and-map = who · map
mods = mods
length = length
size = size
to-telegram = Send to Telegram
delete = Delete
...
stays-here = Videos stay on this computer
why-sign-in = Link this device to Telegram to open the networked features, and to be able to work for your chat.
sign-in = Sign in with Telegram
sign-in-how = Open a chat with the bot and start it. It will get this code and link the device.
code-lasts = Good for five minutes
waiting-confirm = Waiting for the answer…
...
stats = Statistics
sign-out = Sign out
esc-close = Escape closes the menu.
all-read = All read
videos-go-to = Videos go to
build = Build
as-worker = as a worker
on-this-device = on this device
jobs-done = Jobs done
replays-in-journal = Replays in the journal
rendered-count = Rendered
sent-count = Sent to Telegram
...
community = Community
community-why = Coming later, as part of one ecosystem with the bot…
...
language = Language
look-tile = Interface
scale-to-monitor = Fit to the monitor
scale = Scale
scale-auto = auto
device-tile = Device
scene-tile = Scene
...
play = Watch
pause = Pause
watch-again = From the start
earlier-video = Previous
later-video = Next
back-five = Five seconds back
ahead-five = Five seconds ahead
frame-back = A frame back
frame-ahead = A frame ahead
speed = Speed
...
worker-take = Take work from the bot
worker-about = While this is on, the application takes replays from members of your groups through the bot, draws them at 1080p and 60 FPS with even loudness, and sends them back to Telegram. Your own renders wait until the worker is done.
worker-off = Off
worker-waiting = Waiting for work
worker-resting = Waiting for your own render to finish
worker-offline = The bot does not answer
worker-taken = Took a job
worker-getting-replay = Fetching the replay
worker-getting-map = Finding the map
worker-getting-skin = Fetching the skin
worker-drawing = Drawing
worker-polishing = Evening out the loudness
worker-sending = Sending the video
worker-speed = Speed
worker-fps = { $n } fps
worker-delivered = Delivered
worker-handed-back = Handed back
worker-last-delivered = Last: delivered “{ $title }”
worker-last-back = Last: handed back “{ $title }” — { $reason }
worker-not-paired = The application is not paired with the bot — the farm gives it no work without that.
worker-no-ffmpeg = No ffmpeg — a video cannot be made without it.
worker-left = { $left } left
worker-busy = The worker is drawing for the farm — wait until it is done.
farm-head = Farm
farm-waiting = waiting: { $n }
farm-nobody = Nobody is online right now
farm-this = this device
farm-rendering = drawing
farm-ready = waiting for work
farm-resting = resting
...
update-latest = This is the latest
update-found = Out now:
update-getting = Downloading
update-ready = ready to go in
update-ready-quiet = goes in while you're away
update-ready-waits = goes in once the work is done
update-failed = Didn't work
update-moved = the application was moved while it ran — restart it and the update will go through
update-quarantined = macOS started Dossier from quarantine: move Dossier.app into Applications, open it from there and updates will work
update-damaged = the archive arrived damaged — try again
update-empty = the archive holds no application for this system
update-source = Built from source — update with git
update-now = Update
