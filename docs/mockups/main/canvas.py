...
names = ["BentoApp", "BentoBot", "BentoBoth", "BentoStatic", "BentoSettings", "BentoFocus", "BentoChips", "BentoAbove", "SettingsTiles", "SettingsSidebar", "SettingsRender", "SettingsSources", "SettingsColumn"]
